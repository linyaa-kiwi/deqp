...
static const std::tuple<deUint32, deUint32, deUint32, const char*, const char*>	instanceExtensionDependencies[]	=
{
	...
	std::make_tuple(0, 1, 3, "VK_MVK_ios_surface", "VK_KHR_surface"),
	std::make_tuple(0, 1, 0, "VK_MVK_macos_surface", "VK_KHR_surface"),
...
static const std::tuple<deUint32, deUint32, deUint32, const char*, const char*>	deviceExtensionDependencies[]	=
{
	...
	std::make_tuple(0, 1, 1, "VK_EXT_display_control", "VK_KHR_swapchain"),
	std::make_tuple(0, 1, 2, "VK_EXT_display_control", "VK_EXT_display_surface_counter"),
	...
	std::make_tuple(0, 1, 1, "VK_GGP_frame_token", "VK_GGP_stream_descriptor_surface"),
	std::make_tuple(0, 1, 2, "VK_GGP_frame_token", "VK_KHR_swapchain"),
	...
	std::make_tuple(0, 1, 1, "VK_KHR_swapchain_mutable_format", "VK_KHR_swapchain"),
	...
	std::make_tuple(0, 1, 1, "VK_KHR_video_encode_queue", "VK_KHR_synchronization2"),
	...
	std::make_tuple(0, 1, 1, "VK_QCOM_rotated_copy_commands", "VK_KHR_copy_commands2"),
	...
	std::make_tuple(0, 1, 0, "VK_EXT_external_memory_acquire_unmodified", "VK_KHR_external_memory"),
